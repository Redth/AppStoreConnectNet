...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppEventVideoClipUpdateRequestDataAttributes : IEquatable<AppEventVideoClipUpdateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public AppEventVideoClipUpdateRequestDataAttributes(string previewFrameTimeCode = default(string), bool uploaded = default(bool))
        {
        ...
        {
            return this.Equals(input as AppEventVideoClipUpdateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if AppEventVideoClipUpdateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AppEventVideoClipUpdateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppEventVideoClipUpdateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
