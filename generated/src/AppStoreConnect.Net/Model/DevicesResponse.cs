...
namespace AppStoreConnect.Model
{
    ...
    public partial class DevicesResponse : IEquatable<DevicesResponse>, IValidatableObject
    {
        ...
        public DevicesResponse(List<Device> data = default(List<Device>), PagedDocumentLinks links = default(PagedDocumentLinks), PagingInformation meta = default(PagingInformation))
        {
