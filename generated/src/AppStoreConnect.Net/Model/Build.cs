...
namespace AppStoreConnect.Model
{
    ...
    public partial class Build : IEquatable<Build>, IValidatableObject
    {
        ...
        public Build(TypeEnum type = default(TypeEnum), string id = default(string), BuildAttributes attributes = default(BuildAttributes), BuildRelationships relationships = default(BuildRelationships), ResourceLinks links = default(ResourceLinks))
        {
            this.Type = type;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Build and cannot be null");
            }
            this.Links = links;
