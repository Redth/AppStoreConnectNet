...
namespace AppStoreConnect.Model
{
    ...
    public partial class CiPullRequestStartCondition : IEquatable<CiPullRequestStartCondition>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CiPullRequestStartCondition);
        }

        /// <summary>
        /// Returns true if CiPullRequestStartCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of CiPullRequestStartCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CiPullRequestStartCondition input)
        {
            if (input == null)
            {
                return false;
