...
namespace AppStoreConnect.Model
{
    ...
    public partial class BetaAppClipInvocationResponse : IEquatable<BetaAppClipInvocationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BetaAppClipInvocationResponse);
        }

        /// <summary>
        /// Returns true if BetaAppClipInvocationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BetaAppClipInvocationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BetaAppClipInvocationResponse input)
        {
            if (input == null)
            {
                return false;
