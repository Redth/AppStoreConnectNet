...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppCustomProductPageVersionCreateRequestDataRelationships : IEquatable<AppCustomProductPageVersionCreateRequestDataRelationships>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AppCustomProductPageVersionCreateRequestDataRelationships);
        }

        /// <summary>
        /// Returns true if AppCustomProductPageVersionCreateRequestDataRelationships instances are equal
        /// </summary>
        /// <param name="input">Instance of AppCustomProductPageVersionCreateRequestDataRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppCustomProductPageVersionCreateRequestDataRelationships input)
        {
            if (input == null)
            {
                return false;
