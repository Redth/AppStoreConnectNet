...
namespace AppStoreConnect.Model
{
    ...
    public partial class ProfileResponse : IEquatable<ProfileResponse>, IValidatableObject
    {
        ...
        public ProfileResponse(Profile data = default(Profile), List<ProfilesResponseIncludedInner> included = default(List<ProfilesResponseIncludedInner>), DocumentLinks links = default(DocumentLinks))
        {
