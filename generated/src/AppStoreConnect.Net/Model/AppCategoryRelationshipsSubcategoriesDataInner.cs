...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppCategoryRelationshipsSubcategoriesDataInner : IEquatable<AppCategoryRelationshipsSubcategoriesDataInner>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        {
            return this.Equals(input as AppCategoryRelationshipsSubcategoriesDataInner);
        }

        /// <summary>
        /// Returns true if AppCategoryRelationshipsSubcategoriesDataInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AppCategoryRelationshipsSubcategoriesDataInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppCategoryRelationshipsSubcategoriesDataInner input)
        {
            if (input == null)
            {
                return false;
