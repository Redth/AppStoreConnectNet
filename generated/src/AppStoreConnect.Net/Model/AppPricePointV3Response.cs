...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppPricePointV3Response : IEquatable<AppPricePointV3Response>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AppPricePointV3Response);
        }

        /// <summary>
        /// Returns true if AppPricePointV3Response instances are equal
        /// </summary>
        /// <param name="input">Instance of AppPricePointV3Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppPricePointV3Response input)
        {
            if (input == null)
            {
                return false;
