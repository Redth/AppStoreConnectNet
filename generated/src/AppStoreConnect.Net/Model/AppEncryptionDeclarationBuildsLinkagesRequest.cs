...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppEncryptionDeclarationBuildsLinkagesRequest : IEquatable<AppEncryptionDeclarationBuildsLinkagesRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AppEncryptionDeclarationBuildsLinkagesRequest);
        }

        /// <summary>
        /// Returns true if AppEncryptionDeclarationBuildsLinkagesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AppEncryptionDeclarationBuildsLinkagesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppEncryptionDeclarationBuildsLinkagesRequest input)
        {
            if (input == null)
            {
                return false;
