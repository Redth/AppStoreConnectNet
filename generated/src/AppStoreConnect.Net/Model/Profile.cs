...
namespace AppStoreConnect.Model
{
    ...
    public partial class Profile : IEquatable<Profile>, IValidatableObject
    {
        ...
        public Profile(TypeEnum type = default(TypeEnum), string id = default(string), ProfileAttributes attributes = default(ProfileAttributes), ProfileRelationships relationships = default(ProfileRelationships), ResourceLinks links = default(ResourceLinks))
        {
            this.Type = type;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Profile and cannot be null");
            }
            this.Links = links;
