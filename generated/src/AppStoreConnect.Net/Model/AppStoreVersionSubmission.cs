...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppStoreVersionSubmission : IEquatable<AppStoreVersionSubmission>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public AppStoreVersionSubmission(TypeEnum type = default(TypeEnum), string id = default(string), AppStoreVersionSubmissionRelationships relationships = default(AppStoreVersionSubmissionRelationships), ResourceLinks links = default(ResourceLinks))
        {
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for AppStoreVersionSubmission and cannot be null");
            }
            this.Links = links;
        ...
        {
            return this.Equals(input as AppStoreVersionSubmission);
        }

        /// <summary>
        /// Returns true if AppStoreVersionSubmission instances are equal
        /// </summary>
        /// <param name="input">Instance of AppStoreVersionSubmission to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppStoreVersionSubmission input)
        {
            if (input == null)
            {
                return false;
