...
namespace AppStoreConnect.Model
{
    ...
    public partial class BetaAppLocalizationAttributes : IEquatable<BetaAppLocalizationAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BetaAppLocalizationAttributes);
        }

        /// <summary>
        /// Returns true if BetaAppLocalizationAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of BetaAppLocalizationAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BetaAppLocalizationAttributes input)
        {
            if (input == null)
            {
                return false;
