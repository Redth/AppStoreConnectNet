...
namespace AppStoreConnect.Model
{
    ...
    public partial class SubscriptionPromotionalOffersResponse : IEquatable<SubscriptionPromotionalOffersResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SubscriptionPromotionalOffersResponse);
        }

        /// <summary>
        /// Returns true if SubscriptionPromotionalOffersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionPromotionalOffersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionPromotionalOffersResponse input)
        {
            if (input == null)
            {
                return false;
