...
namespace AppStoreConnect.Model
{
    ...
    public partial class InAppPurchaseV2UpdateRequestDataAttributes : IEquatable<InAppPurchaseV2UpdateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public InAppPurchaseV2UpdateRequestDataAttributes(string name = default(string), string reviewNote = default(string), bool familySharable = default(bool), bool availableInAllTerritories = default(bool))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as InAppPurchaseV2UpdateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if InAppPurchaseV2UpdateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of InAppPurchaseV2UpdateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InAppPurchaseV2UpdateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
