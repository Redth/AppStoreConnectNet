...
namespace AppStoreConnect.Model
{
    ...
    public partial class SubscriptionOfferCodeOneTimeUseCodeCreateRequestData : IEquatable<SubscriptionOfferCodeOneTimeUseCodeCreateRequestData>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        {
            return this.Equals(input as SubscriptionOfferCodeOneTimeUseCodeCreateRequestData);
        }

        /// <summary>
        /// Returns true if SubscriptionOfferCodeOneTimeUseCodeCreateRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionOfferCodeOneTimeUseCodeCreateRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionOfferCodeOneTimeUseCodeCreateRequestData input)
        {
            if (input == null)
            {
                return false;
