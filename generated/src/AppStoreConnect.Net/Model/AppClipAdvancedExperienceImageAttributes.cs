...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppClipAdvancedExperienceImageAttributes : IEquatable<AppClipAdvancedExperienceImageAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public AppClipAdvancedExperienceImageAttributes(int fileSize = default(int), string fileName = default(string), string sourceFileChecksum = default(string), ImageAsset imageAsset = default(ImageAsset), List<UploadOperation> uploadOperations = default(List<UploadOperation>), AppMediaAssetState assetDeliveryState = default(AppMediaAssetState))
        {
        ...
        {
            return this.Equals(input as AppClipAdvancedExperienceImageAttributes);
        }

        /// <summary>
        /// Returns true if AppClipAdvancedExperienceImageAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AppClipAdvancedExperienceImageAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppClipAdvancedExperienceImageAttributes input)
        {
            if (input == null)
            {
                return false;
