...
namespace AppStoreConnect.Model
{
    ...
    public partial class SubscriptionUpdateRequestDataAttributes : IEquatable<SubscriptionUpdateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public SubscriptionUpdateRequestDataAttributes(string name = default(string), bool familySharable = default(bool), SubscriptionPeriodEnum? subscriptionPeriod = default(SubscriptionPeriodEnum?), string reviewNote = default(string), int groupLevel = default(int), bool availableInAllTerritories = default(bool))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as SubscriptionUpdateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if SubscriptionUpdateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionUpdateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionUpdateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
