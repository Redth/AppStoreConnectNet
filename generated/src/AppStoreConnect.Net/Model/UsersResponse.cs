...
namespace AppStoreConnect.Model
{
    ...
    public partial class UsersResponse : IEquatable<UsersResponse>, IValidatableObject
    {
        ...
        public UsersResponse(List<User> data = default(List<User>), List<App> included = default(List<App>), PagedDocumentLinks links = default(PagedDocumentLinks), PagingInformation meta = default(PagingInformation))
        {
