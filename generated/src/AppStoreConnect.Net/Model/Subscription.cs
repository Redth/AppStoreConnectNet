...
namespace AppStoreConnect.Model
{
    ...
    public partial class Subscription : IEquatable<Subscription>, IValidatableObject
    {
        ...
        public Subscription(TypeEnum type = default(TypeEnum), string id = default(string), SubscriptionAttributes attributes = default(SubscriptionAttributes), SubscriptionRelationships relationships = default(SubscriptionRelationships), ResourceLinks links = default(ResourceLinks))
        {
            this.Type = type;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Subscription and cannot be null");
            }
            this.Links = links;
