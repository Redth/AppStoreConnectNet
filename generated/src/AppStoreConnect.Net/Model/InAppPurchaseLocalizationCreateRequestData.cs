...
namespace AppStoreConnect.Model
{
    ...
    public partial class InAppPurchaseLocalizationCreateRequestData : IEquatable<InAppPurchaseLocalizationCreateRequestData>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        {
            return this.Equals(input as InAppPurchaseLocalizationCreateRequestData);
        }

        /// <summary>
        /// Returns true if InAppPurchaseLocalizationCreateRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of InAppPurchaseLocalizationCreateRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InAppPurchaseLocalizationCreateRequestData input)
        {
            if (input == null)
            {
                return false;
