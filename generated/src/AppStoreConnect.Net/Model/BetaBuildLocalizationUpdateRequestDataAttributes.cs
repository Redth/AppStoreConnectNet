...
namespace AppStoreConnect.Model
{
    ...
    public partial class BetaBuildLocalizationUpdateRequestDataAttributes : IEquatable<BetaBuildLocalizationUpdateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BetaBuildLocalizationUpdateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if BetaBuildLocalizationUpdateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of BetaBuildLocalizationUpdateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BetaBuildLocalizationUpdateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
