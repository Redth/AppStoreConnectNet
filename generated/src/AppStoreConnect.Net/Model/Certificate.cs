...
namespace AppStoreConnect.Model
{
    ...
    public partial class Certificate : IEquatable<Certificate>, IValidatableObject
    {
        ...
        public Certificate(TypeEnum type = default(TypeEnum), string id = default(string), CertificateAttributes attributes = default(CertificateAttributes), ResourceLinks links = default(ResourceLinks))
        {
            this.Type = type;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Certificate and cannot be null");
            }
            this.Links = links;
