...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppClipDefaultExperienceLocalizationCreateRequest : IEquatable<AppClipDefaultExperienceLocalizationCreateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AppClipDefaultExperienceLocalizationCreateRequest);
        }

        /// <summary>
        /// Returns true if AppClipDefaultExperienceLocalizationCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AppClipDefaultExperienceLocalizationCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppClipDefaultExperienceLocalizationCreateRequest input)
        {
            if (input == null)
            {
                return false;
