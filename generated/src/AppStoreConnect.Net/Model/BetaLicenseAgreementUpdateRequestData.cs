...
namespace AppStoreConnect.Model
{
    ...
    public partial class BetaLicenseAgreementUpdateRequestData : IEquatable<BetaLicenseAgreementUpdateRequestData>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        {
            return this.Equals(input as BetaLicenseAgreementUpdateRequestData);
        }

        /// <summary>
        /// Returns true if BetaLicenseAgreementUpdateRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of BetaLicenseAgreementUpdateRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BetaLicenseAgreementUpdateRequestData input)
        {
            if (input == null)
            {
                return false;
