...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppEncryptionDeclarationDocumentAttributes : IEquatable<AppEncryptionDeclarationDocumentAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AppEncryptionDeclarationDocumentAttributes);
        }

        /// <summary>
        /// Returns true if AppEncryptionDeclarationDocumentAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AppEncryptionDeclarationDocumentAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppEncryptionDeclarationDocumentAttributes input)
        {
            if (input == null)
            {
                return false;
