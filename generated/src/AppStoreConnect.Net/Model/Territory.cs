...
namespace AppStoreConnect.Model
{
    ...
    public partial class Territory : IEquatable<Territory>, IValidatableObject
    {
        ...
        public Territory(TypeEnum type = default(TypeEnum), string id = default(string), TerritoryAttributes attributes = default(TerritoryAttributes), ResourceLinks links = default(ResourceLinks))
        {
            this.Type = type;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Territory and cannot be null");
            }
            this.Links = links;
