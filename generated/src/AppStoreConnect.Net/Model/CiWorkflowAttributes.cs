...
namespace AppStoreConnect.Model
{
    ...
    public partial class CiWorkflowAttributes : IEquatable<CiWorkflowAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CiWorkflowAttributes);
        }

        /// <summary>
        /// Returns true if CiWorkflowAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of CiWorkflowAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CiWorkflowAttributes input)
        {
            if (input == null)
            {
                return false;
