...
namespace AppStoreConnect.Model
{
    ...
    public partial class CiWorkflowUpdateRequestDataAttributes : IEquatable<CiWorkflowUpdateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CiWorkflowUpdateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if CiWorkflowUpdateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of CiWorkflowUpdateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CiWorkflowUpdateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
