...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppEventLocalizationCreateRequestDataAttributes : IEquatable<AppEventLocalizationCreateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AppEventLocalizationCreateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if AppEventLocalizationCreateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AppEventLocalizationCreateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppEventLocalizationCreateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
