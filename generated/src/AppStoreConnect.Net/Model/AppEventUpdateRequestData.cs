...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppEventUpdateRequestData : IEquatable<AppEventUpdateRequestData>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        {
            return this.Equals(input as AppEventUpdateRequestData);
        }

        /// <summary>
        /// Returns true if AppEventUpdateRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of AppEventUpdateRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppEventUpdateRequestData input)
        {
            if (input == null)
            {
                return false;
