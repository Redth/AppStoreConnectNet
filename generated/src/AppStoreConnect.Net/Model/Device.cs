...
namespace AppStoreConnect.Model
{
    ...
    public partial class Device : IEquatable<Device>, IValidatableObject
    {
        ...
        public Device(TypeEnum type = default(TypeEnum), string id = default(string), DeviceAttributes attributes = default(DeviceAttributes), ResourceLinks links = default(ResourceLinks))
        {
            this.Type = type;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Device and cannot be null");
            }
            this.Links = links;
