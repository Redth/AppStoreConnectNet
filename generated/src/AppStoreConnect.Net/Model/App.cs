...
namespace AppStoreConnect.Model
{
    ...
    public partial class App : IEquatable<App>, IValidatableObject
    {
        ...
        public App(TypeEnum type = default(TypeEnum), string id = default(string), AppAttributes attributes = default(AppAttributes), AppRelationships relationships = default(AppRelationships), ResourceLinks links = default(ResourceLinks))
        {
            this.Type = type;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for App and cannot be null");
            }
            this.Links = links;
