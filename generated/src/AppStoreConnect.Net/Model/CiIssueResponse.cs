...
namespace AppStoreConnect.Model
{
    ...
    public partial class CiIssueResponse : IEquatable<CiIssueResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CiIssueResponse);
        }

        /// <summary>
        /// Returns true if CiIssueResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CiIssueResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CiIssueResponse input)
        {
            if (input == null)
            {
                return false;
