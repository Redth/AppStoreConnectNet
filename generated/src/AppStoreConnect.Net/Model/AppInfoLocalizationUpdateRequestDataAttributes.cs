...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppInfoLocalizationUpdateRequestDataAttributes : IEquatable<AppInfoLocalizationUpdateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AppInfoLocalizationUpdateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if AppInfoLocalizationUpdateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AppInfoLocalizationUpdateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppInfoLocalizationUpdateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
