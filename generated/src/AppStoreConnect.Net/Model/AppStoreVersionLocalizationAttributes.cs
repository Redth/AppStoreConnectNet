...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppStoreVersionLocalizationAttributes : IEquatable<AppStoreVersionLocalizationAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AppStoreVersionLocalizationAttributes);
        }

        /// <summary>
        /// Returns true if AppStoreVersionLocalizationAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AppStoreVersionLocalizationAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppStoreVersionLocalizationAttributes input)
        {
            if (input == null)
            {
                return false;
