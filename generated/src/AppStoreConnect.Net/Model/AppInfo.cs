...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppInfo : IEquatable<AppInfo>, IValidatableObject
    {
        ...
        public AppInfo(TypeEnum type = default(TypeEnum), string id = default(string), AppInfoAttributes attributes = default(AppInfoAttributes), AppInfoRelationships relationships = default(AppInfoRelationships), ResourceLinks links = default(ResourceLinks))
        {
            this.Type = type;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for AppInfo and cannot be null");
            }
            this.Links = links;
