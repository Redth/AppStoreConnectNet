...
namespace AppStoreConnect.Model
{
    ...
    public partial class ScmPullRequest : IEquatable<ScmPullRequest>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public ScmPullRequest(TypeEnum type = default(TypeEnum), string id = default(string), ScmPullRequestAttributes attributes = default(ScmPullRequestAttributes), ScmGitReferenceRelationships relationships = default(ScmGitReferenceRelationships), ResourceLinks links = default(ResourceLinks))
        {
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for ScmPullRequest and cannot be null");
            }
            this.Links = links;
        ...
        {
            return this.Equals(input as ScmPullRequest);
        }

        /// <summary>
        /// Returns true if ScmPullRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ScmPullRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScmPullRequest input)
        {
            if (input == null)
            {
                return false;
