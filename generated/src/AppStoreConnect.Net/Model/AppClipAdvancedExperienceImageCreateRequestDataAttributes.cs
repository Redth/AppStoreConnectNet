...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppClipAdvancedExperienceImageCreateRequestDataAttributes : IEquatable<AppClipAdvancedExperienceImageCreateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AppClipAdvancedExperienceImageCreateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if AppClipAdvancedExperienceImageCreateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AppClipAdvancedExperienceImageCreateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppClipAdvancedExperienceImageCreateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
