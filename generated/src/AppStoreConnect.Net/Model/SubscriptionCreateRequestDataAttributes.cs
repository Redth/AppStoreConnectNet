...
namespace AppStoreConnect.Model
{
    ...
    public partial class SubscriptionCreateRequestDataAttributes : IEquatable<SubscriptionCreateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public SubscriptionCreateRequestDataAttributes(string name = default(string), string productId = default(string), bool familySharable = default(bool), SubscriptionPeriodEnum? subscriptionPeriod = default(SubscriptionPeriodEnum?), string reviewNote = default(string), int groupLevel = default(int), bool availableInAllTerritories = default(bool))
        {
        ...
        {
            return this.Equals(input as SubscriptionCreateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if SubscriptionCreateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionCreateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionCreateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
