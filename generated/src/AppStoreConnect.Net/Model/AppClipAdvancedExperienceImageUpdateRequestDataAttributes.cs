...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppClipAdvancedExperienceImageUpdateRequestDataAttributes : IEquatable<AppClipAdvancedExperienceImageUpdateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AppClipAdvancedExperienceImageUpdateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if AppClipAdvancedExperienceImageUpdateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AppClipAdvancedExperienceImageUpdateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppClipAdvancedExperienceImageUpdateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
