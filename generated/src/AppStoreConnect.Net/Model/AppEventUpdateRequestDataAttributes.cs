...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppEventUpdateRequestDataAttributes : IEquatable<AppEventUpdateRequestDataAttributes>, IValidatableObject
    {
        /// <summary>
        /// Defines Badge
        /// </summary>
        ...
        public AppEventUpdateRequestDataAttributes(string referenceName = default(string), BadgeEnum? badge = default(BadgeEnum?), string deepLink = default(string), PurchaseRequirementEnum? purchaseRequirement = default(PurchaseRequirementEnum?), string primaryLocale = default(string), PriorityEnum? priority = default(PriorityEnum?), PurposeEnum? purpose = default(PurposeEnum?), List<AppEventAttributesTerritorySchedulesInner> territorySchedules = default(List<AppEventAttributesTerritorySchedulesInner>))
        {
        ...
        {
            return this.Equals(input as AppEventUpdateRequestDataAttributes);
        }

        /// <summary>
        /// Returns true if AppEventUpdateRequestDataAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of AppEventUpdateRequestDataAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppEventUpdateRequestDataAttributes input)
        {
            if (input == null)
            {
                return false;
