...
namespace AppStoreConnect.Model
{
    ...
    public partial class AppStoreReviewAttachmentUpdateRequestData : IEquatable<AppStoreReviewAttachmentUpdateRequestData>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        {
            return this.Equals(input as AppStoreReviewAttachmentUpdateRequestData);
        }

        /// <summary>
        /// Returns true if AppStoreReviewAttachmentUpdateRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of AppStoreReviewAttachmentUpdateRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppStoreReviewAttachmentUpdateRequestData input)
        {
            if (input == null)
            {
                return false;
